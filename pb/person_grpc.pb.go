...
func (c *personClient) PersonList(ctx context.Context, in *PersonListRequest, opts ...grpc.CallOption) (*PersonListResponse, error) {
	out := new(PersonListResponse)
	err := c.cc.Invoke(ctx, "/rpc.Person/PersonList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPersonServer) PersonList(context.Context, *PersonListRequest) (*PersonListResponse, error) {
...
func _Person_PersonList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PersonListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PersonServer).PersonList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpc.Person/PersonList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PersonServer).PersonList(ctx, req.(*PersonListRequest))
	}
...
var Person_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "rpc.Person",
	HandlerType: (*PersonServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "PersonList",
			Handler:    _Person_PersonList_Handler,
		},
	},
